...
export default function LandingPage() {
  ...
  const onSubmitMessage = async (e) => {
    e.preventDefault();
    if (!auth & (contact.firstName==="" || contact.lastName==="" || contact.email===""  || contact.subject ===""  || contact.message ===""))
    Swal.fire({
        icon: "info",
        title: "Oops...",
        text: "Field is required",
      });
    else if (auth & (contact.subject ===""  || contact.message ==="") ) 
    {
        Swal.fire({
            icon: "info",
            title: "Oops...",
    ...
    <div>
      ...
      <div className="container py-14">
        <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
          Famous cities in morocco
        </h1>
        <div className="w-full">
          <div className="h-1 mx-auto bg-primary gradient w-64 opacity-25 my-0 py-0 rounded-t mb-4"></div>
        </div>
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-3">
          <div className="relative group rounded-sm overflow-hidden">
            <img
              alt=""
              src={require("../Assets/images/Rabat.jpg")}
              className="w-full"
            />
            <Link
              to="city/6/places"
          ...
          <div className="relative group rounded-sm overflow-hidden">
            <img
              alt=""
              src={require("../Assets/images/Marrakech.jpg")}
              className="w-full"
            />
            <Link
              to="city/2/places"
          ...
          <div className="relative group rounded-sm overflow-hidden">
            <img
              alt=""
              src={require("../Assets/images/Agadir.jpg")}
              className="w-full"
            />
            <Link
              to="city/1/places"
          ...
          <div className="relative group rounded-sm overflow-hidden">
            <img
              alt=""
              src={require("../Assets/images/dakhla.jpg")}
              className="w-full"
            />
            <Link
              to="city/4/places"
          ...
          <div className="relative group rounded-sm overflow-hidden">
            <img
              alt=""
              src={require("../Assets/images/Casablanca.jpg")}
              className="w-full"
            />
            <Link
              to="city/3/places"
      ...
      <section id="about" className="bg-white py-8">
        <div className="container max-w-5xl mx-auto m-8">
          ...
          <div className="w-full">
            <div className="h-1 mx-auto bg-primary gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
          </div>
      ...
      <section id="contact">
        <div className="container max-w-4xl mx-auto m-8">
          ...
          <div className="bg-gray-900 w-full">
            <div className="max-w-5xl bg-gray-900 mx-auto px-6 sm:px-6 lg:px-8">
              <div className="bg-gray-900 w-full shadow rounded p-8 sm:p-12">
                <form onSubmit={onSubmitMessage}>
                  ...
                  <div className="flex items-center justify-center w-full">
                    <button className="mt-9 font-semibold leading-none text-white py-4 px-10 bg-primary rounded hover:bg-primary focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:outline-none">
                      Send message
                    </button>
                  </div>
                </form>
